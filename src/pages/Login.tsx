...
const Login = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center gap-5 min-h-screen">
      <form className="bg-white border rounded-lg flex flex-col gap-4 px-25 py-5 max-w-2xl w-full" onSubmit={handleSubmit(onsubmit)}>
        <div className="flex flex-col justify-center items-center gap-3 p-4">
          <h1 className="text-4xl">Log in</h1>
          <p className="text-sm">Dont have an account? <span className="cursor-pointer text-blue-400 text-sm">Sign up</span></p>
        </div>
        ...
        <div className="p-1 flex flex-col border hover:border-blue-500 rounded-lg">
          ...
          <input className="p-1 outline-none border-none" type="email" {...register("email", { required: "Enter an email address, like name@example.com" })} />
        </div>
        ...
        <div className=" flex flex-col border hover:border-blue-500 rounded-lg">
          ...
          <input className="p-1 outline-none border-none" type="password" {...register("password", { required: "This field is required" })} />
        </div>
        {errors.password && <span className="text-red-500 text-sm font-semibold flex items-center">
          <CircleAlert className="mr-1" size={15} />
          {errors.password.message}</span>}
        <span className="cursor-pointer underline hover:text-slate-500">Forgot Password?</span>
        <button className="bg-blue-700 text-white rounded-lg py-4 text-xl mb-7 hover:bg-blue-500 cursor-pointer" type="submit">Login</button>
        <div className="flex items-center">
          <div className="grow border-t border-gray-300"></div>
          <span className="mx-4 text-sm text-gray-500">OR</span>
          <div className="grow border-t border-gray-300"></div>
        </div>
        <button className="btn btn-xl bg-white text-black border-[#e5e5e5]">
        ...
        <button className="btn btn-xl bg-[#1A77F2] text-white border-[#005fd8]">
